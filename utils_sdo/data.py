...
from utils_sdo.toolkit import split_images_labels
...
class iDomainnetCIL(iData):
    ...
    def download_data(self):
        rootdir = '../Sp/dataset/domainnet'

        train_txt = './utils_sdo/datautils/domainnet/train.txt'
        test_txt = './utils_sdo/datautils/domainnet/test.txt'
